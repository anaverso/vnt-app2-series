...
import 'package:vnt_app2_series/star_rating.dart';
  ...
  Widget build(BuildContext context) {
    ...
    void submit() {
      if (_formKey.currentState!.validate()) {
        ...
        // add newTvShow to list
        // Provider.of<TvShowModel>(
        //   context,
        //   listen: false,
        // ).addNewTvShow(newTvShow, context);
        ...
        isEditing
            ...
            : context.read<TvShowModel>().addNewTvShow(
                newTvShow,
                context,
              ); // quero escutar mas apenas lendo sem provocar alterações
